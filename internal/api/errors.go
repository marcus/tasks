...
// httpError carries a status, a stable machine code, a human sentence, and the
// structured details a client branches on.
//
...
var errorMessages = map[string]string{
	...
	// not_implemented is this build's honest refusal for a route the store
