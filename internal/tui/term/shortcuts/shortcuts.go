...
var Registry = []Entry{
	...
	entry(Entry{Sequences: []string{"r"}, DisplayKey: "r", Description: "recur — weekly · every mon · m:15 · off", Contexts: []Context{List, Detail}, Handler: "open_recur_popup", Availability: "selected_action_available?", Palette: PaletteWhen("recurrence_action_available?"), Form: "recurrence"}),
	...
	entry(Entry{Sequences: []string{"a"}, DisplayKey: "a", Description: "Restore rejected proposal", Contexts: []Context{List, Detail}, Handler: "unreject_proposal", Availability: "reject_restore_available?", Palette: PaletteWhen("reject_restore_available?")}),
	...
	entry(Entry{Sequences: []string{"c"}, DisplayKey: "c", Description: "complete project", Contexts: []Context{List}, Handler: "complete_project", Availability: "project_open_selected?", Palette: PaletteWhen("project_open_selected?")}),
	entry(Entry{Sequences: []string{"r"}, DisplayKey: "r", Description: "reopen project", Contexts: []Context{List}, Handler: "reopen_project", Availability: "project_closed_selected?", Palette: PaletteWhen("project_closed_selected?")}),
	entry(Entry{Sequences: nil, DisplayKey: "palette", Description: "drop project", Contexts: []Context{List}, Handler: "drop_project", Availability: "project_open_selected?", Palette: PaletteWhen("project_open_selected?")}),
