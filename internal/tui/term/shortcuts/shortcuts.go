...
var Registry = []Entry{
	...
	entry(Entry{Sequences: []string{"\r", "\n"}, DisplayKey: "return", Description: "confirm modal action", CommandID: "modal-confirm", HideInHelp: true, Contexts: []Context{Modal}, Handler: "modal_confirmation", Availability: "modal_confirmation_accepts_enter?"}),
	entry(Entry{Sequences: []string{"n", "N", "\x1b", "q"}, DisplayKey: "n / esc", Description: "cancel modal action", CommandID: "modal-cancel", FooterLabel: "Cancel", FooterPriority: 2, Contexts: []Context{Modal}, Handler: "modal_confirmation", Availability: "modal_confirmation_available?", HideInHelp: true}),
