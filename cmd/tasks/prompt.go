...
import (
	...
	"github.com/marcus/tasks/internal/agentdiff"
...
func (s *surfaceContext) prompt(args []string) int {
	// The schema gate first, in the position tasks:3582 applies it — at
	...
	// defaults.
	system, err := agentcontext.Build(s.paths, runtimepath.TasksCLI(), promptfacts.Sources{})
	if err != nil {
