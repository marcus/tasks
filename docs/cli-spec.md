...
| `link add <ref> <url> [--label TEXT]` | | ✅ | Append one formal link. A configured shorthand expands before storage and becomes the default label. Duplicate and invalid/non-web URLs refuse. |
