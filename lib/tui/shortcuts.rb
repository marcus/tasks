...
module Tui
  ...
  module Shortcuts
    ...
    REGISTRY = [
      ...
      entry(sequences: ["r"],          key: "r",       description: "recur — weekly · every mon · m:15 · off", contexts: %i[list detail], handler: :open_recur_popup, palette: :recurrence_action_available?, form: :recurrence),
      ...
      entry(sequences: ["z"],          key: "z",       description: "defer until — date/time · someday · now", contexts: %i[list detail], handler: :defer_selected, palette: :selected_action_available?, form: :defer_until),
      entry(sequences: ["D"],          key: "D",       description: "Delegate… — email · refine · research · implement · release · off", contexts: %i[list detail], handler: :delegate_selected, availability: :delegation_action_available?, palette: :delegation_action_available?, form: :delegate),
      entry(sequences: ["W"],          key: "W",       description: "Set work reference… — URL/id · off", contexts: %i[list detail], handler: :set_work_ref_selected, availability: :delegation_action_available?, palette: :delegation_action_available?, form: :work_ref),
      ...
      entry(sequences: ["y"],          key: "y",       description: "yank stable task id",              contexts: %i[list detail], handler: :yank_ref, palette: :selected_action_available?),
      ...
      entry(sequences: ["p"],          key: "p",       description: "paste task id into the prompt",    contexts: %i[list detail], handler: :paste_ref, palette: :selected_action_available?),
      ...
      entry(sequences: ["\t"],         key: "tab",       description: "ask the agent — CRUD anything",    contexts: [:detail], handler: :focus_prompt),
