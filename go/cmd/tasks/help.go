...
// same dispatch data bin/tasks resolves aliases through, and `help --json`
...
// helpText is bin/tasks HELP, byte for byte. It is stderr/stdout contract:
